...
void protobuf_AssignDesc_JointState_2eproto() GOOGLE_ATTRIBUTE_COLD;
...
void protobuf_AddDesc_JointState_2eproto() GOOGLE_ATTRIBUTE_COLD;
...
void JointState::set_has_header() {
  _has_bits_[0] |= 0x00000001u;
}
void JointState::clear_has_header() {
  _has_bits_[0] &= ~0x00000001u;
}
...
const ::gz_std_msgs::Header& JointState::header() const {
  // @@protoc_insertion_point(field_get:gz_sensor_msgs.JointState.header)
  return header_ != NULL ? *header_ : *default_instance_->header_;
}
::gz_std_msgs::Header* JointState::mutable_header() {
  set_has_header();
  if (header_ == NULL) {
...
::gz_std_msgs::Header* JointState::release_header() {
...
void JointState::set_allocated_header(::gz_std_msgs::Header* header) {
  delete header_;
  header_ = header;
  if (header) {
    set_has_header();
